  ...
  return (
    <nav className="bg-white border-b border-gray-100 sticky top-0 z-50">
      ...
      <div className="sm:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 flex justify-around p-3 pb-safe z-50">
        <Link
          href="/search"
          className={`flex flex-col items-center gap-1 p-2 ${pathname === '/search' ? 'text-[#8A2BE2]' : 'text-gray-500'}`}
        >
        ...
        <Link
          href="/dashboard"
          className={`flex flex-col items-center gap-1 p-2 ${pathname === '/dashboard' ? 'text-[#8A2BE2]' : 'text-gray-500'}`}
        >
        ...
        <Link
          href="/profile"
          className={`flex flex-col items-center gap-1 p-2 ${pathname === '/profile' ? 'text-[#8A2BE2]' : 'text-gray-500'}`}
        >
